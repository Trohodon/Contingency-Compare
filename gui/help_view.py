    ...
    def _get_sections(self):
        return {
            ...
            "Neighbor Studies: N-1 P1": [
                ...
                ("num", "1) Reuses a fully processed *_ACCA_N-1.PWB case, or saves a working copy from *_CA_NOT_RUN_N-1.PWB."),
                ("num", "2) Applies the bundled N-1 settings and solves new cases using PowerWorld distributed computing."),
                ...
                ("p", "Each company workbook has one sheet per completed study, including Percent Change. A sheet says when no P1 violations matched. Each CON file contains the contingencies behind that company's filtered P1 violations."),
